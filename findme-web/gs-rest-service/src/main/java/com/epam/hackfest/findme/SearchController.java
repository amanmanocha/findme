...
public class SearchController {
	...
	public User search(
		...
		Future<Object> future = Patterns.ask(Application.getActor(),
				new SearchUserCommand(firstName, secondName, new PhoneNumber(
						phone)), 10 * 1000);
	...
	public ResultState register(
		...
		RegisterUserCommand registerUserCommand = new RegisterUserCommand(
				firstName, secondName, new PhoneNumber(phone));
	...
	public ResultState addOldNumber(
			...
			@RequestParam(value = "isPrivate", required = true, defaultValue = "") boolean isCurrentPhonePrivate)
			throws Exception {
		SetOldNumberCommand setOldNumberCommand = new SetOldNumberCommand(
				!isCurrentPhonePrivate, new PhoneNumber(currentPhone),
				new PhoneNumber(oldPhone));
